...
const sheet = attachments.helper.selectSheet('FOR CUSTOMER');
...
- `attachments.helper.selectSheet(nameOrIndex)`
...
3. **Plan mutations**: document intent, execute, verify, log diff.
