 ...
 *
 * This script manages the step-by-step workflow for uploading and
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const wizardHTML = `
        <div id="wizard" class="wizard">
            ...
            <div id="step-2" class="wizard-step" data-step="2">
            ...
            <div id="step-3" class="wizard-step" data-step="3">
    ...
    const handleFile = async (file) => {
        ...
        try {
            workbook = await window.excelCore.parseFile(file);
            console.log('File parsed successfully:', workbook);
    ...
    const handleSheetSelection = (sheetName) => {
        ...
        if (worksheet) {
            ...
            window.tableRenderer.render(worksheet, previewContainer);
    ...
    const renderMappingInterface = (worksheet) => {
        const mappingContainer = document.getElementById('mapping-interface');
        mappingContainer.innerHTML = ''; // Clear previous interface
